...
const AddCargo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await cargoAPI.create(dataToSubmit);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-900">Add New Cargo</h2>
          <p className="text-gray-600 mt-1">Create a new cargo entry</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex space-x-4 pt-4">
            ...
            >
              ...
              <span>{loading ? 'Saving...' : 'Save Cargo'}</span>
            </button>
